...
public class StandingsService : IStandingsService
{
    ...
    Task<object> IStandingsService.GetCardStatsAsync(int tournamentId)
    {
        throw new NotImplementedException();
    }

    Task<object> IStandingsService.GetStandingsAsync(int tournamentId)
    {
        throw new NotImplementedException();
    }

    Task<object> IStandingsService.GetTopScorersAsync(int tournamentId)
    {
        throw new NotImplementedException();
    }
